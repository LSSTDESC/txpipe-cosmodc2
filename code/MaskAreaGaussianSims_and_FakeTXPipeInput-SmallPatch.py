...
folder_cut = '/global/projecta/projectdirs/lsst/groups/WL/users/jprat/gaussian_sims_srdnzs_fullsky/%s/smaller_patch/'%vname
...
for zbin in range(1,6):
    ...
    ra, dec, g1, g2 = cat.T
    mask = (dec>dec_lim)&(dec<0)&(ra<ra_lim)
    print(len(ra))
